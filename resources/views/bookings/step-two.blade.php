                    ...
                    <div class="flex space-x-4">
                        ...
                        <div class="flex-1 py-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center space-x-1.5">
                                    <img src="{{ asset('assets/icons/event.svg') }}" class="w-4 h-4" alt="address" />
                                ...
                                <div class="flex items-center space-x-1.5">
                                    <img src="{{ asset('assets/icons/calendar.svg') }}" class="w-4 h-4 filter brightness-0"
                                        alt="date" />
                                    <span
                                        class="text-[#06071C] text-sm">{{ $event->date->locale('id')->translatedFormat('l, d F Y') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="text-[#06071C] text-sm">Kategori</span>
                        </div>
            ...
            <div class="bg-white rounded-2xl px-6 py-6 shadow-sm space-y-6 mt-4">
                ...
                <div class="accordion-content space-y-6 mt-4">
                    ...
                    <div class="space-y-2">
                        <div class="bg-blue-50 rounded-lg px-5 py-4 border border-blue-200">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <p class="text-blue-800 text-sm font-medium">Pembayaran Aman dengan Pakasir</p>
                                    <p class="text-blue-600 text-xs mt-1">Anda akan diarahkan ke halaman pembayaran aman
                                        Pakasir dimana Anda dapat memilih metode pembayaran yang diinginkan.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <label for="confirm-payment" class="text-[#06071C] text-base font-semibold cursor-pointer">Saya
                            Setuju</label>
                    </div>
                    <div class="border-t border-dashed border-[#E4E5E9]"></div>
