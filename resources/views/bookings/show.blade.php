        ...
        <div class="relative flex flex-col w-full max-w-[640px] min-h-screen mx-auto bg-[#F6F8FA] overflow-x-hidden">
            <div class="space-y-5">
                ...
                <div class="bg-white rounded-3xl p-5 relative overflow-hidden">
                    ...
                    <div class="space-y-4">
                        <h1 class="text-[#06071C] text-base font-bold text-center">Tiket Anda</h1>
                        <!-- Divider -->
                            ...
                            <div class="flex gap-8">
                                <div class="flex-1 flex items-center gap-2.5">
                                    <img src="{{ asset('assets/icons/note.svg') }}" class="w-6 h-6 filter brightness-0"
                                        alt="note" />
                                    <div class="flex-1">
                                        <p class="text-[#9BA4A6] text-sm font-normal">Kode</p>
                                ...
                                <div class="flex-1 flex items-center gap-2.5">
                                    <img src="{{ asset('assets/icons/note.svg') }}" class="w-6 h-6 filter brightness-0"
                                        alt="note" />
                                    <div class="flex-1">
                                        <p class="text-[#9BA4A6] text-sm font-normal">Nama</p>
                            ...
                            <div class="flex gap-8">
                                ...
                                <div class="flex-1 flex items-center gap-2.5">
                                    <img src="{{ asset('assets/icons/note.svg') }}" class="w-6 h-6 filter brightness-0"
                                        alt="note" />
                                    <div>
                                        <p class="text-[#9BA4A6] text-sm font-normal">Kode Pos</p>
                                        <p class="text-[#06071C] text-base font-bold">
                                ...
                                <div class="flex-1 flex items-center gap-2.5">
                                    ...
                                    <img src="{{ asset('assets/icons/note.svg') }}" class="w-6 h-6 filter brightness-0"
                                        alt="note" />
                                    <div class="flex-1">
                                        <p class="text-[#9BA4A6] text-sm font-normal">Mulai</p>
                                        <p class="text-[#06071C] text-base font-bold">
                ...
                <div class="bg-white rounded-3xl p-5">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <h2 class="text-[#06071C] text-base font-bold">Tiket - {{ $booking->event->title }}</h2>
